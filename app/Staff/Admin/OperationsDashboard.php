...
final class OperationsDashboard {
 ...
 public function menu(): void { add_menu_page(__('My PWT Work','wildtours-plugin'),__('My PWT Work','wildtours-plugin'),Capabilities::ACCESS_DASHBOARD,'pwt-my-work',[$this,'render'],'dashicons-clipboard',4); }
